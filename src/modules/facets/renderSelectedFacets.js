...
export default function() {
	try {
		...
		let selectedUi = ``;
		const { selectedFacets = {}, facet = {} } = this.options;
		...
		return selectedFacetTemp(selectedUi, facet, selectedFacets);
	} catch (err) {
		this.onError("facets > renderSelectedFacets.js", err, events.runtimeError);
	}
}
