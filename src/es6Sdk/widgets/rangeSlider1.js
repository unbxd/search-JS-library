const RangeSlider = function(props) {
  ...
  export default UnbxdRangeSlider;
  
  // -------------------
  // How to use? 
  /*
  var UnbxdRangeSlider = new RangeSlider('my-slider');
  
  UnbxdRangeSlider.onChange = function(min, max)
  {
    console.log(min, max, this);
   // document.getElementById('result').innerHTML = 'Min: ' + min + ' Max: ' + max;
  }
  
  UnbxdRangeSlider.didChanged = function(min, max)
  {
    console.log(min,max, this);
    //document.getElementById('result').innerHTML = 'Min: ' + min + ' Max: ' + max;
  }
