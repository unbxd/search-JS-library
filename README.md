...
| getQueryParams | Function | null | here you can decode the url and return the params.  Refer this [method](https://github.com/unbxd/search-JS-core/blob/master/src/modules/url/getQueryParams.js). you need to return an object in below format<code>{"q": "dress","filter": [ "size_uFilter:M OR size_uFilter:L", "type_uFilter:Rompers"],"sort": "","rows": 12,"start": 0 } </code> |
