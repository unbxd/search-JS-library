...
| getQueryParams | Function | null | here you can decode the url and return the params.  Refer this [methods](https://github.com/unbxd/search-JS-core/blob/master/src/modules/url/getQueryParams.js). you need to return an object in below format <pre><code>{
    "q": "dress",
