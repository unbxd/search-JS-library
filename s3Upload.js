...
const uploadJsSource = `aws s3 cp public/dist/js/vanillaSearch.source.js s3://unbxd/search-sdk/v${packageJson.version}/vanillaSearch.source.js --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers`;
